# Translating Journey Forward into Afrikaans

Thank you — truly. Journey Forward is a free, offline app that helps people stay
sober, and a translation means it can help Afrikaans-speaking people too. There's no
deadline and no pressure; even a little helps.

## How to do it

1. Open **`journey_Afrikaans_af.csv`** in Google Sheets or Excel.
2. Each row is one piece of text from the app. Type your translation into the
   **last column** (titled "Afrikaans (af)"). That column starts empty — that's
...
| --- | --- | --- |
| **1** | Short buttons, tabs and labels | Does the most — it makes the whole app *look* like it speaks Afrikaans. Quick: a few words each. |
...
5. **Tone:** warm, calm, plain, never clinical or shaming. Picture talking gently
   ...
   choose the wording a kind person would actually say in Afrikaans.
