...
List<_Section> _buildSections(AppLocalizations l10n) => [
      _Section(
          ...
          title: l10n.privacyAllDataOnDevice,
          body: l10n.privacyAllDataOnDeviceBody),
      _Section(
          icon: Icons.wifi_off_rounded,
          title: l10n.privacyNoInternet,
          body: l10n.privacyNoInternetBody),
      _Section(
          icon: Icons.analytics_outlined,
          title: l10n.privacyNoAnalytics,
          body: l10n.privacyNoAnalyticsBody),
      _Section(
          icon: Icons.contact_emergency_outlined,
          title: l10n.privacyEmergencyContacts,
          body: l10n.privacyEmergencyContactsBody),
      _Section(
          icon: Icons.backup_outlined,
          title: l10n.privacyBackupRestore,
          body: l10n.privacyBackupRestoreBody),
      _Section(
          icon: Icons.lock_outline_rounded,
          title: l10n.privacyPINBiometric,
          body: l10n.privacyPINBiometricBody),
      _Section(
          icon: Icons.delete_outline_rounded,
          title: l10n.privacyHowToDelete,
          body: l10n.privacyHowToDeleteBody),
      _Section(
          icon: Icons.child_care_outlined,
          title: l10n.privacyChildrenPrivacy,
          body: l10n.privacyChildrenPrivacyBody),
      _Section(
          icon: Icons.update_rounded,
          title: l10n.privacyPolicyUpdates,
          body: l10n.privacyPolicyUpdatesBody),
    ];
        ...
        child: Row(
          ...
          children: [
            Container(
              ...
              child: Icon(section.icon, color: AppColors.forest600, size: 20),
            ),
